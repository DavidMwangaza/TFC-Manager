<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.departments.index') }}" class="text-gray-500 hover:text-gray-700">
                        ...
                        <form method="POST" action="{{ route('admin.departments.store') }}" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="faculty" id="faculty" value="{{ old('faculty') }}" required list="faculties"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Choisissez une faculté existante ou tapez un nouveau nom.</p>
                                </div>
                            ...
                            <div class="flex justify-end gap-3 pt-4 border-t">
                                <a href="{{ route('admin.departments.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 text-sm rounded-md hover:bg-gray-300 transition">
                                    Annuler
                                </a>
