<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.academic-years.index') }}" class="text-gray-500 hover:text-gray-700">
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        <form method="POST" action="{{ route('admin.academic-years.store') }}" class="space-y-6">
                            ...
                            <div class="flex justify-end gap-3 pt-4 border-t">
                                <a href="{{ route('admin.academic-years.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 text-sm rounded-md hover:bg-gray-300 transition">
                                    Annuler
                                </a>
