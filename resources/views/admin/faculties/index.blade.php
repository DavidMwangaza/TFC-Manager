                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Filières</th>
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach($faculties as $faculty)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-4 py-3 text-sm text-gray-500">{{ Str::limit($faculty->description, 60) }}</td>
                                                <td class="px-4 py-3 text-sm text-gray-600">{{ $faculty->departments_count }}</td>
