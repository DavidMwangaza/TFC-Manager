...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        ...
        <h1 class="mt-4 text-3xl font-bold text-gray-900">Accès interdit</h1>
        <p class="mt-2 text-gray-600">{{ $exception->getMessage() ?: 'Vous n\'avez pas les droits nécessaires pour accéder à cette page.' }}</p>
