...
<body class="bg-slate-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        ...
        <h1 class="mt-4 text-3xl font-bold text-slate-900">Erreur interne du serveur</h1>
        <p class="mt-2 text-slate-600">Une erreur inattendue s'est produite. Nos équipes ont été notifiées.</p>
