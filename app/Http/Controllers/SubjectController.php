...
class SubjectController extends Controller
{
    ...
    public function show(Subject $subject)
    {
        ...
        if ($user->hasRole('Chef Departement') && $subject->department_id !== $user->department_id) {
    ...
    public function store(Request $request)
    {
        ...
        $chefsDept = User::role('Chef Departement')
    ...
    public function validateSubject(Request $request, Subject $subject)
    {
        ...
        $subject->load('student');
        $subject->teacher->notify(new TeacherAssigned($subject));
